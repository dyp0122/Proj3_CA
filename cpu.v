...
module ControlUnit(
    ...
    input [15:0] PC,
    input [15:0] RF_data1, RF_data2, // RF에서 ALU로 데이터 연결--rf 데이터를 여기서 받음
    ...
    output reg [15:0] RF_data3,// ALU에서 나온 결과를 RF에 쓰기 위한 데이터
    ...
    always @(*) begin
        ...
        RF_addr1 = data[9:8]; // rs는 instruction의 9-8비트
        RF_addr2 = data[7:6]; // rt는 instruction의 7-6비트
        RF_addr3 = data[5:4]; // rd는 instruction의 5-4비트
    end
